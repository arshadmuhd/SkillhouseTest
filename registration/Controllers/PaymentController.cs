...
namespace registration.Controllers
{
    public class PaymentController : Controller
    {
        ...
        private const string _key = "rzp_test_FQga5G3r2dtTRv";
        private const string _secret = "n8er1A1DBIuTeF3jw7z7JxSw";

        public ViewResult Event()
        {
            var model = new RegistrationModel() { Amount = 200 };
            return View(model);
        }
...
*/
        ...
        public ViewResult Payment(RegistrationModel registration)
        {
           ...
           /*     Notes = new Dictionary<string, string>()
          {
            ...
            RegistrationModel regtrmodel = new RegistrationModel()
            {
            ...
            _db.RazorpayOptions.Add(razorPayOptions);
